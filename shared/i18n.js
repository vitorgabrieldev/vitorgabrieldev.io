...
(function () {
  const DICT = {
    ...
    'about.head_title': { pt: 'Um engenheiro full-stack com <em>viés de infra</em>, instinto de produto e atenção aos trade-offs.', en: 'A full-stack engineer with <em>an infra bias</em>, a product instinct, and attention to trade-offs.' },
    'about.bio.p1': { pt: 'Projeto e entrego sistemas SaaS orientados por confiabilidade e escalabilidade. Laravel é minha base, mas meu trabalho se estende por toda a stack — desde modelagem de dados e otimizações de banco até state management e infraestrutura de produção.', en: 'I design and deliver SaaS systems built for reliability and scalability. Laravel is my foundation, but my work spans the entire stack — from data modeling and database optimization to state management and production infrastructure.' },
    'about.bio.p2': { pt: 'Desde 2023 na <strong>Clickweb</strong>, evoluí de estagiário a full-stack pleno com foco em sistemas que escalam. Profundo em infraestrutura: CI/CD pipelines, containerização (Docker, Kubernetes), nginx, Linux hardening, observabilidade e disaster recovery. Responsável por manter aplicações mission-critical em produção — se precisa de uptime garantido, eu desenho e gerencio a infraestrutura.', en: "Since 2023 at <strong>Clickweb</strong>, I evolved from intern to full-stack pleno with focus on systems that scale. Deep in infrastructure: CI/CD pipelines, containerization (Docker, Kubernetes), nginx, Linux hardening, observability and disaster recovery. Responsible for keeping mission-critical applications in production — when uptime is non-negotiable, I design and manage the infrastructure." },
    'about.bio.p3': { pt: 'Arquitetura é sobre trade-offs, não dogmas. Cada decisão técnica tem custo: performance vs. manutenibilidade, abstração vs. simplicidade, flexibilidade vs. velocidade. As melhores decisões vêm quando entendo <em>por que</em> o negócio escolhe um caminho — quais são os reais constrangimentos, qual é o timeline, qual é o risco de errar. Code elegance sem impacto de negócio é luxo que times em crescimento não podem pagar.', en: "Architecture is about trade-offs, not dogma. Every technical decision has a cost: performance vs. maintainability, abstraction vs. simplicity, flexibility vs. velocity. The best decisions come when I understand <em>why</em> the business chooses a path — what are the real constraints, what's the timeline, what's the risk of failure. Code elegance without business impact is a luxury that growing teams cannot afford." },
    'about.bio.p4': { pt: 'Aprendizado contínuo é não-negociável. Leio papers acadêmicos, documentação técnica, RFC de protocolos, commit histories de projetos high-performance. Ultimamente: transformers e LLMs — tokenização, atenção, arquiteturas modernas. Não é sobre seguir trends; é sobre construir expertise genuína. Entender de verdade — não superficialmente — como as coisas funcionam.', en: 'Continuous learning is non-negotiable. I read academic papers, technical documentation, protocol RFCs, commit histories from high-performance projects. Currently: transformers and LLMs — tokenization, attention mechanisms, modern architectures. Not about following trends; it\'s about building genuine expertise. Understanding deeply — not superficially — how things really work.' },
